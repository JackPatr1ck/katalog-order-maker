            ...
            <div className="w-60 rounded-2xl bg-card border border-border shadow-card p-4">
              ...
              <div className="flex gap-2">
                {["WhatsApp", "Instagram", "TikTok"].map((p) => (
                  <div key={p} className="flex-1 aspect-square rounded-xl bg-accent flex items-center justify-center">
                    <span className="text-[10px] font-semibold text-primary">{p[0]}</span>
                  </div>
                ))}
              </div>
            </div>
